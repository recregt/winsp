...
fn launch_path(path: &str) -> Result<(), String> {
    ...
    let instance = unsafe { ShellExecuteW(None, w!("open"), &path, None, None, SW_SHOWNORMAL) };
...
fn shell_execute_error_message(code: usize) -> String {
    ...
    use windows::Win32::UI::Shell::{
        ...
        SE_ERR_DDETIMEOUT, SE_ERR_DLLNOTFOUND, SE_ERR_FNF, SE_ERR_NOASSOC, SE_ERR_OOM, SE_ERR_PNF,
        SE_ERR_SHARE,
    };
