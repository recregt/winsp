...
[`AtomKind`](crate::matcher::pattern::AtomKind)).
...
#![warn(missing_docs)]
// The scoring matrix's arena allocator needs `unsafe`; `winsp-index`'s crate
// root denies it everywhere else.
#![allow(unsafe_code)]
// Vendored from https://github.com/helix-editor/nucleo (nucleo-matcher 0.3.1),
// kept as close to upstream as possible; these lints didn't exist, or fired
// differently, under the edition it was published for (2021, vs. this
// crate's 2024), and are silenced here rather than reformatting third-party
// code.
#![allow(
...
// Only a slice of this module's public surface is reachable from the rest of
// `winsp-index`; the remainder is kept intact for fidelity with upstream
// rather than trimmed to just what we currently call.
#![allow(dead_code)]
...
pub use crate::matcher::config::Config;
pub use crate::matcher::utf32_str::{Utf32Str, Utf32String};

use crate::matcher::chars::{AsciiChar, Char};
use crate::matcher::matrix::MatrixSlab;
...
impl Matcher {
    ...
    /// [greedy matching](crate::matcher::Matcher::fuzzy_match_greedy) for large
    /// needles and haystacks.
    ///
    /// See the [matcher documentation](crate::matcher::Matcher) for more details.
    ...
    /// (crate::matcher::Matcher::fuzzy_match_greedy) for large needles and haystacks
    ///
    /// See the [matcher documentation](crate::matcher::Matcher) for more details.
    ...
    /// indices and scores. Usually [fuzzy_match](crate::matcher::Matcher::fuzzy_match) should
    /// be preferred.
    ///
    /// See the [matcher documentation](crate::matcher::Matcher) for more details.
    ...
    /// indices and scores. Usually [fuzzy_indices](crate::matcher::Matcher::fuzzy_indices) should
    /// be preferred.
    ///
    /// See the [matcher documentation](crate::matcher::Matcher) for more details.
