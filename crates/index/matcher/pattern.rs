...
use crate::matcher::{Matcher, Utf32Str, chars};
...
pub enum AtomKind {
    ...
    ///
    /// See also [`Matcher::fuzzy_match`](crate::matcher::Matcher::fuzzy_match).
    Fuzzy,
    ...
    /// `'foo` and `!foo` (negated).
    ///
    /// See also [`Matcher::substring_match`](crate::matcher::Matcher::substring_match).
    Substring,
    ...
    /// `!^foo` (negated).
    ///
    /// See also [`Matcher::prefix_match`](crate::matcher::Matcher::prefix_match).
    Prefix,
    ...
    /// `!foo$` (negated).
    ///
    /// See also [`Matcher::postfix_match`](crate::matcher::Matcher::postfix_match).
    Postfix,
    ...
    /// (negated).
    ///
    /// See also [`Matcher::exact_match`](crate::matcher::Matcher::exact_match).
    Exact,
}
...
/// A text pattern made up of (potentially multiple) [atoms](crate::matcher::pattern::Atom).
#[non_exhaustive]
pub struct Pattern {
